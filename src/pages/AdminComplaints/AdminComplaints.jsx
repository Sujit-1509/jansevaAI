                            ...
                            <div className="bulk-dropdown-wrap">
                                ...
                                {bulkDropdown && (
                                    <div className="bulk-dropdown">
                                        ...
                                        <button onClick={() => handleBulkAction('set_status', 'in_progress')}>In progress</button>
                                    </div>
                                )}
                            </div>
